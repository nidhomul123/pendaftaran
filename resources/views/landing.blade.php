            ...
            <div class="container">
                ...
                <div class="row">
                    <form id="contactForm" data-sb-form-api-token="API_TOKEN">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <div class="captcha row">
                                        ...
                                        <div class="col">
                                            <input class="form-control" id="captcha" type="text" placeholder="Masukkan captcha" data-sb-validations="required" />
                                            <div class="invalid-feedback" data-sb-feedback="captcha:required">Captcha tidak boleh kosong</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <!-- Submit Button-->
                        <div class="text-center"><button class="btn btn-primary btn-xl text-uppercase disabled" id="submitButton" type="submit">Simpan Data</button></div>
                    </form>
                </div>
            </div>
        </section>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="{{ asset('agency/assets/img/logos/microsoft.svg') }}" alt="..." aria-label="Microsoft Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="{{ asset('agency/assets/img/logos/google.svg') }}" alt="..." aria-label="Google Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="{{ asset('agency/assets/img/logos/facebook.svg') }}" alt="..." aria-label="Facebook Logo" /></a>
                    </div>
                    <div class="col-md-3 col-sm-6 my-3">
                        <a href="#!"><img class="img-fluid img-brand d-block mx-auto" src="{{ asset('agency/assets/img/logos/ibm.svg') }}" alt="..." aria-label="IBM Logo" /></a>
                    </div>
                </div>
            </div>
        </div>
